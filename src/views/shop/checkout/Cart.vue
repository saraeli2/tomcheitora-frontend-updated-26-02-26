        ...
        >
          ...
          >
            <IconBtn
              ...
              @click="checkoutCartDataLocal.removeFromCart(item)"
            >
              <VIcon
                size="20"
                icon="tabler-x"
              ...
              <div class="d-flex flex-column gap-y-2">
                ...
                >
                  <VBtn
                    ...
                    icon="tabler-minus"
                    size="small"
                    @click="checkoutCartDataLocal.decrementQty(item)"
                  />
                  <VBtn
                    min-width="28"
                    variant="outlined"
                  ...
                  <VBtn
                    ...
                    icon="tabler-plus"
                    size="small"
                    @click="checkoutCartDataLocal.incrementQty(item)"
                  />
                </VBtnGroup>
              </div>
